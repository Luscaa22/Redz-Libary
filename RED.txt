...
local redzlib = {
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)),
			...
			["Color Hub 2"] = Color3.fromRGB(50, 30, 70),
			["Color Stroke"] = Color3.fromRGB(80, 60, 100),
			["Color Theme"] = Color3.fromRGB(140, 100, 180),
...
function redzlib:MakeWindow(Configs)
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Sair",
			Text = "Tem Certeza que quer Fechar o Chaos Hub ?",
			Options = {
				{"Sim", function()
					ScreenGui:Destroy()
				end},
